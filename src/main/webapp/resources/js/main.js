(function ($) {
    ...
    function makeTimer() {
        var endTime = new Date("July 11, 2021 17:00:00 PDT");
    ...
    $('.partner-slides').owlCarousel({
        ...
        margin: 40,
        navText: ["<i class='flaticon-null'></i>", "<i class='flaticon-null'></i>"],
        responsive: {0: {items: 2, margin: 30,}, 576: {items: 3, margin: 30,}, 768: {items: 4,}, 992: {items: 5,}}
    });
    ...
    $('.products-slides').owlCarousel({
        ...
        margin: 30,
        navText: ["<i class='flaticon-null-4'></i>", "<i class='flaticon-null-4'></i>"],
        responsive: {0: {items: 1,}, 576: {items: 2,}, 768: {items: 2,}, 992: {items: 4,}}
    });
